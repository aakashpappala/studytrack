...
export default function TodayTasksPage() {
  ...
  const filteredTasks = tasks.filter((task) => {
    if (viewTab === 'TODAY') {
      ...
      if (!isTaskToday && !isOverduePending) {
        return false;
      }
    }
  ...
  const todayCompleted = todayTasksList.filter(
                      ...
                      <div className="flex flex-col gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-500 mt-1">
                            Upload an image or video showing that you completed this task.
                          </p>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-3">
                          ...
                          <button
                            ...
                            className="px-5 py-3 rounded-xl bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-300 disabled:cursor-not-allowed text-white text-xs font-bold transition-all flex items-center justify-center gap-2"
                          >
